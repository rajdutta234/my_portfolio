...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1337: x0 => new WeakRef(x0),
      _1338: x0 => x0.deref(),
      _1345: () => globalThis.WeakRef,
      _1349: s => JSON.stringify(s),
      _1350: s => printToConsole(s),
      _1351: (o, p, r) => o.replaceAll(p, () => r),
      _1352: (o, p, r) => o.replace(p, () => r),
      _1353: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1354: s => s.toUpperCase(),
      _1355: s => s.trim(),
      _1356: s => s.trimLeft(),
      _1357: s => s.trimRight(),
      _1358: (string, times) => string.repeat(times),
      _1359: Function.prototype.call.bind(String.prototype.indexOf),
      _1360: (s, p, i) => s.lastIndexOf(p, i),
      _1361: (string, token) => string.split(token),
      _1362: Object.is,
      _1366: (o, c) => o instanceof c,
      _1367: o => Object.keys(o),
      _1397: x0 => new Array(x0),
      _1399: x0 => x0.length,
      _1401: (x0,x1) => x0[x1],
      _1402: (x0,x1,x2) => { x0[x1] = x2 },
      _1405: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1407: x0 => new Int8Array(x0),
      _1408: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1410: x0 => new Uint8ClampedArray(x0),
      _1412: x0 => new Int16Array(x0),
      _1414: x0 => new Uint16Array(x0),
      _1416: x0 => new Int32Array(x0),
      _1418: x0 => new Uint32Array(x0),
      _1420: x0 => new Float32Array(x0),
      _1422: x0 => new Float64Array(x0),
      _1446: x0 => x0.random(),
      _1449: () => globalThis.Math,
      _1462: (ms, c) =>
      ...
      _1469: (x0,x1) => x0.exec(x1),
      _1470: (x0,x1) => x0.test(x1),
      _1471: x0 => x0.pop(),
      _1473: o => o === undefined,
      _1475: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1477: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1478: o => o instanceof RegExp,
      _1479: (l, r) => l === r,
      _1480: o => o,
      _1481: o => o,
      _1482: o => o,
      ...
      _1484: o => o.length,
      _1486: (o, i) => o[i],
      _1487: f => f.dartFunction,
      _1488: () => ({}),
      _1489: () => [],
      _1491: () => globalThis,
      _1492: (constructor, args) => {
      ...
      _1494: (o, p) => o[p],
      _1495: (o, p, v) => o[p] = v,
      _1496: (o, m, a) => o[m].apply(o, a),
      _1498: o => String(o),
      _1499: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1500: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1500(f,arguments.length,x0) }),
      _1501: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._1501(f,arguments.length,x0,x1) }),
      _1502: o => {
      ...
      _1535: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1536: (x0,x1) => x0.send(x1),
      _1537: x0 => x0.send(),
      ...
      _1546: (x0,x1,x2) => x0.open(x1,x2),
      _1547: x0 => x0.abort(),
      _1548: x0 => x0.getAllResponseHeaders(),
      _1549: () => new AbortController(),
      _1550: x0 => x0.abort(),
      _1551: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1552: (x0,x1) => globalThis.fetch(x0,x1),
      _1553: (x0,x1) => x0.get(x1),
      _1554: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1554(f,arguments.length,x0,x1,x2) }),
      _1555: (x0,x1) => x0.forEach(x1),
      _1556: x0 => x0.getReader(),
      _1557: x0 => x0.cancel(),
      _1558: x0 => x0.read(),
      _1559: o => o instanceof Array,
      _1560: (a, i) => a.push(i),
      _1564: a => a.pop(),
      _1565: (a, i) => a.splice(i, 1),
      _1566: (a, s) => a.join(s),
      _1567: (a, s, e) => a.slice(s, e),
      _1569: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1570: a => a.length,
      _1572: (a, i) => a[i],
      _1573: (a, i, v) => a[i] = v,
      _1575: o => {
      ...
      _1576: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1578: o => o instanceof Uint8Array,
      _1579: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1580: o => o instanceof Int8Array,
      _1581: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1582: o => o instanceof Uint8ClampedArray,
      _1583: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1584: o => o instanceof Uint16Array,
      _1585: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1586: o => o instanceof Int16Array,
      _1587: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1588: o => o instanceof Uint32Array,
      _1589: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1590: o => o instanceof Int32Array,
      _1591: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1593: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1594: o => o instanceof Float32Array,
      _1595: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1596: o => o instanceof Float64Array,
      _1597: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1598: (t, s) => t.set(s),
      _1600: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1602: o => o.buffer,
      _1603: o => o.byteOffset,
      _1604: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1605: (b, o) => new DataView(b, o),
      _1606: (b, o, l) => new DataView(b, o, l),
      _1607: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1608: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1609: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1610: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1611: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1612: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1613: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1614: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1615: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1616: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1617: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1618: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1621: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1622: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1623: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1624: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1625: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1626: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1627: Function.prototype.call.bind(Number.prototype.toString),
      _1628: Function.prototype.call.bind(BigInt.prototype.toString),
      _1629: Function.prototype.call.bind(Number.prototype.toString),
      _1630: (d, digits) => d.toFixed(digits),
      _1737: x0 => x0.readyState,
      _1739: (x0,x1) => { x0.timeout = x1 },
      _1741: (x0,x1) => { x0.withCredentials = x1 },
      _1742: x0 => x0.upload,
      _1743: x0 => x0.responseURL,
      _1744: x0 => x0.status,
      _1745: x0 => x0.statusText,
      ...
      _3593: x0 => x0.navigator,
      _3982: x0 => x0.userAgent,
      _6137: x0 => x0.signal,
      _6211: () => globalThis.document,
      _6651: (x0,x1) => { x0.innerHTML = x1 },
      _7973: x0 => x0.value,
      _7975: x0 => x0.done,
      _8677: x0 => x0.url,
      _8679: x0 => x0.status,
      ...
      _8682: x0 => x0.headers,
      _8683: x0 => x0.body,
      _10811: (x0,x1) => { x0.border = x1 },
      _11253: (x0,x1) => { x0.height = x1 },
      _11943: (x0,x1) => { x0.width = x1 },
      _12311: x0 => x0.name,
